                ...
                <CardHeader className="text-center flex flex-col items-center space-y-4 pt-10 pb-6">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <CardTitle className="text-[#002147] text-3xl font-bold tracking-tight">Companies Portal</CardTitle>
                        </div>
                        <CardDescription className="text-gray-500">Company Management for Placement Cell</CardDescription>
                    </div>
                </CardHeader>
