...
CREATE TABLE users (
    ...
    role VARCHAR(20) NOT NULL CHECK (role IN ('student', 'admin', 'coordinator')),
...
-- 3.3 Documents (Reduced to core docs)
...
-- ==========================================
-- 4. MASTER DATA Management (SPOCs)
-- ==========================================
-- 4.1 Single Point of Contacts (Master Table)
...
CREATE TABLE spocs (
    ...
    email VARCHAR(255),
    department VARCHAR(100), -- Optional: if SPOC belongs to a specific dept
