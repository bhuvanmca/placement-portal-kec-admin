...
} from "@/services/eligibility.service"; // Modified
// ... imports
...
export default function CreateDrivePage() {
  ...
  const submitStatusRef = useRef<"open" | "draft">("open");
  ...
  const onSubmit = async (data: DriveFormValues) => {
    ...
    try {
      ...
      const payload = {
        ...
        excluded_student_ids: removedStudentIds,
      };
  ...
  const hasPgDepartments = form
    .watch("eligible_departments")
    ?.some((d) => ["MCA", "MBA", "M.Tech", "M.Sc"].includes(d));
      ...
      <div className="mb-8 p-1 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Fill in the details below to post a new placement drive for
            students.
          </p>
        </div>
      </div>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 pt-6">
                      ...
                      >
                        {form.watch("logo_url") && (
                          <img
                            ...
                            alt="Logo"
                            className="h-10 w-10 object-contain rounded border p-1 bg-white"
                          />
                        )}
                  ...
                  <div className="col-span-1 md:col-span-2 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          appendRole({ role_name: "", ctc: "", stipend: "" })
                        }
                      >
                    ...
                    {roleFields.map((field, index) => (
                      <div
                        key={field.id}
                        className="grid grid-cols-1 md:grid-cols-12 gap-4 items-start border p-4 rounded-lg bg-blue-50/50 relative"
                      >
                        <div className="md:col-span-4 space-y-2">
                          ...
                          <Input
                            {...form.register(
                              `roles.${index}.role_name` as const,
                            )}
                            placeholder="e.g. SDE-1"
                          />
                          {form.formState.errors.roles?.[index]?.role_name && (
                            <p className="text-red-500 text-xs">
                              {
                                form.formState.errors.roles[index]?.role_name
                                  ?.message
                        ...
                        <div className="md:col-span-3 space-y-2">
                          ...
                          <Input
                            {...form.register(`roles.${index}.ctc` as const)}
                            placeholder="e.g. 10 LPA"
                          />
                          {form.formState.errors.roles?.[index]?.ctc && (
                            <p className="text-red-500 text-xs">
                              {form.formState.errors.roles[index]?.ctc?.message}
                            </p>
                          )}
                        </div>
                        ...
                        <div className="md:col-span-2 space-y-2">
                          ...
                          <Input
                            type="number"
                            {...form.register(`roles.${index}.salary` as const)}
                            placeholder="600000"
                          />
                        </div>
                        <div className="md:col-span-2 space-y-2">
                        ...
                        <Button
                          ...
                          className="absolute top-2 right-2 text-red-500 hover:bg-red-50 h-6 w-6"
                        >
                    ...
                    {roleFields.length > 0 && (
                      <p className="text-xs text-muted-foreground">
                        Adding roles here allows students to select specific
                        roles.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2 col-span-1 md:col-span-2 mt-2">
                    <div className="flex items-center space-x-2 border p-4 rounded-lg bg-gray-50/50">
                      ...
                      <div className="grid gap-1.5 leading-none">
                        <label
                          htmlFor="allow_placed_candidates"
                          className="text-sm font-medium leading-none cursor-pointer"
                        >
                          Allow Placed Candidates to Apply
                        </label>
                        <p className="text-xs text-muted-foreground">
                          If checked, students who are already placed can apply
                          for this drive.
                        </p>
                      </div>
                    </div>
                      ...
                      render={({ field }) => (
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="Internship to Full-Time">
                              Internship to Full-Time
                            </SelectItem>
                            <SelectItem value="Internship and Full-Time">
                  ...
                  <div className="col-span-1 md:col-span-2 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <RefreshCw
                          className={`h-3 w-3 ${loadingSpocs ? "animate-spin" : ""}`}
                        />
                      </Button>
                    </div>
                    {spocs.length === 0 ? (
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Manage SPOCs from Settings → SPOCs
                    </p>
                    {form.formState.errors.spoc_id && (
                      <p className="text-red-500 text-xs">
                        {form.formState.errors.spoc_id.message}
                      </p>
                    )}
                  </div>
              ...
              <div className="flex items-center justify-between border-b pb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    type="button"
                    className="h-9 font-medium text-blue-700 bg-blue-50 border-blue-200 hover:bg-blue-100"
                ...
                <CardContent className="space-y-8 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      {form.formState.errors.eligible_batches && (
                        <p className="text-red-500 text-xs">
                          {form.formState.errors.eligible_batches.message}
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        type="number"
                        step="0.1"
                        {...form.register("tenth_percentage")}
                        placeholder="e.g. 60"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="number"
                        step="0.1"
                        {...form.register("twelfth_percentage")}
                        placeholder="e.g. 60"
                        onWheel={(e) => e.currentTarget.blur()}
                      />
                    </div>
                    ...
                    {hasPgDepartments && (
                      <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                        <Label className="text-[#002147] font-semibold">
                          PG Min CGPA
                        </Label>
                        <Input
                          type="number"
                          step="0.01"
                          {...form.register("pg_min_cgpa")}
                          placeholder="e.g. 6.0"
                          className="border-[#002147]/20 bg-blue-50/30"
                          onWheel={(e) => e.currentTarget.blur()}
                        />
                        <p className="text-[10px] text-muted-foreground">
                          Required for PG students only
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="number"
                        {...form.register("max_backlogs_allowed")}
                        onWheel={(e) => e.currentTarget.blur()}
                      />
                    </div>
                  </div>
            ...
            <Element name="schedule" className="space-y-6">
              ...
              <Card className="border-none shadow-sm bg-white/50">
                <CardContent className="space-y-6 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-base font-semibold text-[#002147]">
                        Application Deadline{" "}
                        <span className="text-red-500">*</span>
                      </Label>
                      <p className="text-xs text-muted-foreground mb-2">
                        Last date for students to opt-in.
                      </p>
                      <Controller
                        name="deadline_date"
                        control={form.control}
                      ...
                      />
                      {form.formState.errors.deadline_date && (
                        <p className="text-red-500 text-xs">
                          {form.formState.errors.deadline_date.message}
                        </p>
                      )}
                    </div>
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground mb-2">
                        When is the placement drive taking place?
                      </p>
                      <Controller
                        name="drive_date"
                        control={form.control}
                        render={({ field }) => (
                          <DateTimePicker
                            ...
                            disablePastDates
                            minDate={
                              form.watch("deadline_date")
                                ? new Date(form.watch("deadline_date"))
                                : undefined
                            }
                          />
                        )}
                      />
                      {form.formState.errors.drive_date && (
                        <p className="text-red-500 text-xs">
                          {form.formState.errors.drive_date.message}
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Define the timeline of the placement process.
                    </p>

                    {fields.map((field, index) => (
                      <div
                        key={field.id}
                        className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end border p-4 rounded-lg bg-gray-50/30"
                      >
                        <div className="md:col-span-4 space-y-2">
                          <Label>Round Name</Label>
                          <Input
                            {...form.register(`rounds.${index}.name` as const)}
                        ...
                        <div className="md:col-span-4 space-y-2">
                          ...
                          <Input
                            {...form.register(
                              `rounds.${index}.description` as const,
                            )}
                            placeholder="Details..."
                          />
                        </div>
                ...
                <CardContent className="flex flex-col gap-6 pt-6">
                  ...
                  <div className="flex justify-end gap-4 mt-4">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        submitStatusRef.current = "open";
                        setSubmitStatus("open");
                      }}
                    >
                      {isSubmitting && submitStatus === "open" ? (
                        <>
                          <Loader2 className="mr-2 h-4 w-4 animate-spin" />{" "}
                          Posting...
                        </>
              ...
              <div className="mt-4 flex items-center gap-4">
                <div className="flex gap-2 flex-1">
                  ...
                  <Button
                    type="button"
                    variant="default"
                    className="bg-[#002147] hover:bg-[#003366] h-10"
                  >
            ...
            {previewLoading ? (
              ...
              <div className="flex flex-col items-center justify-center p-12 text-center text-muted-foreground">
                ...
                <p className="font-medium text-gray-700 text-lg">
                  No students match these criteria
                </p>
                <p className="text-sm mt-1">
                  Try loosening the constraints (CGPA, marks, or backlogs).
                </p>
              </div>
            ) : (
                ...
                <Table className="min-w-max border-separate border-spacing-0">
                  <TableHeader className="bg-gray-50/80 sticky top-0 z-20 shadow-sm border-b">
                    <TableRow className="hover:bg-transparent">
                      ...
                      <TableHead className="min-w-[200px] sticky left-0 z-30 bg-gray-50 border-r py-4">
                        Student
                      </TableHead>
                      {visibleColumns.register_number && (
                        <TableHead className="py-4">Register No.</TableHead>
                      )}
                      {visibleColumns.department && (
                        <TableHead className="py-4">Department</TableHead>
                      )}
                      {visibleColumns.batch_year && (
                  ...
                  <TableBody>
                    {displayStudents.map((s) => (
                      ...
                      >
                        ...
                        <TableCell className="font-medium sticky left-0 z-10 bg-white border-r py-4">
                          <div className="flex items-center gap-3 relative z-0">
                            <Avatar className="h-9 w-9 shrink-0 relative mt-0.5 ring-1 ring-gray-100">
                              ...
                              <AvatarFallback className="text-xs bg-[#002147]/5 text-[#002147] font-semibold">
                        ...
                        {visibleColumns.batch_year && (
                          <TableCell className="py-4">{s.batch_year}</TableCell>
                        )}
                        {visibleColumns.tenth_mark && (
                          <TableCell className="text-right py-4">
                            {s.tenth_mark?.toFixed(2) || "—"}
                          </TableCell>
                        )}
                        {visibleColumns.twelfth_mark && (
                          <TableCell className="text-right py-4">
                            {s.twelfth_mark?.toFixed(2) || "—"}
                          </TableCell>
                        )}
                        {visibleColumns.diploma_mark && (
                          <TableCell className="text-right py-4">
                            {s.diploma_mark?.toFixed(2) || "—"}
                          </TableCell>
                        )}
                        {visibleColumns.ug_cgpa && (
                          <TableCell className="text-right py-4 font-medium">
                            {s.ug_cgpa > 0 ? s.ug_cgpa.toFixed(2) : "—"}
                          </TableCell>
                        )}
                        {visibleColumns.pg_cgpa && (
                          <TableCell className="text-right py-4 font-medium">
