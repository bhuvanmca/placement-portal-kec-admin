...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      // ChatService.disconnect(); // Keep connection alive for singleton
    };
  }, []);
        ...
        {selectedGroup || selectedUser ? (
          <>
            ...
            <ChatArea 
                ...
                groupName={selectedGroup?.name || selectedUser?.name || 'New Chat'}
                groupImage={selectedGroup?.image || selectedUser?.profile_photo_url}
          ...
          <div className="flex-1 flex items-center justify-center text-muted-foreground">
            <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">Choose a group or start a new chat to begin messaging</p>
            </div>
          </div>
        )}
      </div>
