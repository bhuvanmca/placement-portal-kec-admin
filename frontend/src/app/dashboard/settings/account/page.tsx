...
export default function AccountSettingsPage() {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authUser) {
        setUser({ ...authUser, name: profile.name });
      }
    } catch (error: any) {
      console.error(error);
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // data.url is a presigned URL for immediate display
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <h1 className="text-2xl font-bold mb-6 text-[#002147]">
        Account Settings
      </h1>
        ...
        <TabsContent value="security" className="space-y-6">
            ...
            <CardContent>
              ...
              >
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="bg-[#002147] hover:bg-[#002147]/90 w-full"
                >
                  {loading ? (
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  ) : null}
          ...
          <Card className="border-red-100">
            <CardHeader>
              ...
              <CardDescription>
                Irreversible actions requiring caution.
              </CardDescription>
            </CardHeader>
            <CardContent>
