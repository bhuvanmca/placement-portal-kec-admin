...
export default function AcademicConfigPage() {
  ...
  const executeDelete = async () => {
    ...
    try {
      ...
      toast.error(
        `Failed to delete ${deleteData.type === "dept" ? "department" : "batch"}`,
      );
    }
    ...
    <div className="flex flex-col gap-6 p-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage departments and batch years.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage available departments (UG/PG).
            </CardDescription>
          </CardHeader>
                      ...
                      <TableRow key={dept.id}>
                        ...
                        <TableCell className="text-right space-x-1">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => initiateDeleteDept(dept)}
                          >
                      ...
                      <TableRow key={batch.id}>
                        ...
                        <TableCell className="text-right space-x-1">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => initiateDeleteBatch(batch)}
                          >
                            <Trash2 className="h-4 w-4 text-red-500" />
                          </Button>
                        </TableCell>
