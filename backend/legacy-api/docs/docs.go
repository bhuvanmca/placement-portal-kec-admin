...
const docTemplate = `{
        ...
        "/v1/admin/analytics/dashboard": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by timeframe: all_time, weekly, monthly, quarterly, half_yearly, annual",
                        "name": "timeframe",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.DashboardAnalytics"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "models.DashboardAnalytics": {
            ...
            "properties": {
                "category_wise": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CategoryWiseAnalytics"
                    }
                },
                "department_wise": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DepartmentWiseAnalytics"
                    }
                },
                "gender_wise": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.GenderWiseAnalytics"
                    }
                },
                "offer_type_wise": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.OfferTypeAnalytics"
                    }
                },
                "salary_wise": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SalaryBracketAnalytics"
                    }
                },
                "top_recruiters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TopRecruitersAnalytics"
                    }
                },
                "year_wise": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.YearWiseAnalytics"
                    }
                }
            }
        },
        ...
        "models.DepartmentWiseAnalytics": {
            "type": "object",
            "properties": {
                "department_code": {
                    "type": "string"
