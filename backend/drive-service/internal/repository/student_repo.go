...
// CreateStudent is unused in the Drive Service context since the Auth/Student microservices handle raw creation.
// Preserved as a stub if needed for future isolated student generation flows or event-based syncing.
func (r *StudentRepository) CreateStudent(ctx context.Context, user *models.User, input models.CreateStudentInput) error {
	return fmt.Errorf("CreateStudent is not implemented in the Drive Service. Use the Student or Auth service.")
}
