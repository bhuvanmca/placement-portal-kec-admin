...
class _AcademicDetailsScreenState extends ConsumerState<AcademicDetailsScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      debugPrint('Failed to load department type: $e');
      if (mounted) {
        setState(() {
          _isLoading = false;
          _hasError = true;
  ...
  void _next() {
    if (_formKey.currentState!.validate()) {
      ...
      final diploma = double.tryParse(_diplomaMarkController.text) ?? 0.0;
      ...
      final diplomaYear = int.tryParse(_diplomaYearController.text);
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Failed to load department info',
