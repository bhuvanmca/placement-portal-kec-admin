...
class AppConstants {
  ...
  static const String baseUrl =
      'http://172.25.32.1/api'; // Works for physical devices & Android/iOS
  static const String apiBaseUrl = 'http://172.25.32.1/api';
  ...
  static String sanitizeUrl(String url) {
    ...
    return url
        .replaceAll('localhost', '172.25.32.1')
        .replaceAll('minio', '172.25.32.1');
  }
}
