...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  // _uploadDocument removed — aadhar/pan document uploads are no longer supported.
  // Only aadhar_number and pan_number are stored (text fields in Identity section).
        ...
        ref.watch(
          profileProvider.select((s) {
            ...
            return (
              ...
              d['twelfth_mark'],
              d['twelfth_board'],
              d['twelfth_institution'],
              d['twelfth_year_pass'],
              d['diploma_mark'],
              d['diploma_institution'],
              d['diploma_university'],
              d['diploma_year_pass'],
              d['ug_cgpa'],
              d['ug_institution'],
              d['ug_university'],
